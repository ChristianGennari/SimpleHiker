...
public class compassActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitude = intent.getDoubleExtra("currentLatitude", 0);
        longitude = intent.getDoubleExtra("currentLongitude", 0);
    ...
    public void onClickGoogleMaps(View view) {
        ...
        intentGoogleMaps.putExtra("currentLatitude", latitude);
        intentGoogleMaps.putExtra("currentLongitude", longitude);
